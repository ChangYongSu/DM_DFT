...
public:	
	...
	int Write_Member(FILE *m_fp, CString lMemberName, int nData);
	int Read_Member(FILE *m_fp, CString lMemberName, CString &nData);
	int Read_Member(FILE *m_fp, CString lMemberName, int &nData);
