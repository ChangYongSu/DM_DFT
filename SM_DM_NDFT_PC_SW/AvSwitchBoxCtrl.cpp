...
{
	m_ComPort.ClosePort(); //m_ctrlAvSwitchBox.ClosePort();
	m_bPortOpen = FALSE;
}
...
BOOL CAvSwitchBox::SendCommString(CString str)
{
	...
	if (lComID == 0)
	{
		g_pView->SendData((BYTE*)(LPCTSTR)str, str.GetLength());
	}
	else
	{
		g_pView->SendData((BYTE*)(LPCTSTR)str, str.GetLength(), lComID);
	}
...
//	memcpy(g_pView->m_SendBuf, (BYTE*)(LPCTSTR)str, str.GetLength());
//	g_pView->m_SendCnt = str.GetLength();
//	g_pView->ComSend();
...
UINT CAvSwitchBox::CheckReceiveMsg(int nCmd, int nWaitLimit, CString& sValue)
{
	...
	if(m_nReceiveCount < nSize)// !ReceiveCommString(nSize, nWaitLimit))
	{
		nRtn = 3;
	}
	else 
...
{	
	...
	UINT nRtn = 0;
	m_strErrMsg = _T("");
	if (m_nAvSwitchCmdPASS == 1)
	{
		return TRUE;
	}
	if (m_nAvSwitchCmd == SEND_REMOTE_CODE)
	{
		if (g_pView->m_ComAck == COM_ACK_OK)
		{
			if (m_nNoRemoteRetryCount < m_nNoRemoteRetry)
			{
				m_nNoRemoteRetryCount++;
				if (g_pView->SendIR_Code(m_sRemoteCode, 0))
				{
					return TEST_WAIT;
				}
				else
	...
	nRtn = CheckReceiveMsg(m_nAvSwitchCmd, m_nAvSwitchWait, sValue);
...
//	_Wait(100);
	...
	m_nAvSwitchCmdPASS = 0;

	m_nAvSwitchCmd = nCmd;
	/*if (nCmd == SET_VIDEO_CH)
	{
		g_pView->SendVideoSel(nValue1);
	}
	else if (nCmd == SET_AUDIO_CH)
	{
		g_pView->SendAudioSel(nValue1);
	}*/
...
//_T("AUX_R"),_T("AUX_L"),
//#define 	_AUDIO_OLD_CH_OPTICAL	1
//#define 	_AUDIO_OLD_CH_COAXIAL	2
//#define 	_AUDIO_OLD_CH_BCH1		3
//#define 	_AUDIO_OLD_CH_BCH2		4
//#define 	_AUDIO_OLD_CH_BCH3		5
//#define 	_AUDIO_OLD_CH_BCH4		6
//#define 	_AUDIO_OLD_CH_AUX		7
//#define 	_AUDIO_OLD_CH_SCART		8
//#define 	_AUDIO_OLD_CH_HDMI		9
//#define 	_AUDIO_NEW_CH_HDMI_R		1
//#define 	_AUDIO_NEW_CH_HDMI_L		2
//#define 	_AUDIO_NEW_CH_MIC1			3
//#define 	_AUDIO_NEW_CH_MIC2			4
//#define 	_AUDIO_NEW_CH_SPDIF_R		5
//#define 	_AUDIO_NEW_CH_SPDIF_L		6
//#define 	_AUDIO_NEW_CH_AUX_R			7
//#define 	_AUDIO_NEW_CH_AUX_L			8
//#define 	_AUDIO_NEW_CH_SPEAK_1R		9
//#define 	_AUDIO_NEW_CH_SPEAK_1L		10
//#define 	_AUDIO_NEW_CH_SPEAK_2R		11
//#define 	_AUDIO_NEW_CH_SPEAK_2L		12
//#define 	_AUDIO_NEW_CH_SPEAK_3R		13
//#define 	_AUDIO_NEW_CH_SPEAK_3L		14
//#define 	_AUDIO_NEW_CH_SPEAK_4R		15
//#define 	_AUDIO_NEW_CH_SPEAK_4L		16
	int lSource1 = 1;
	int lSource2 = 2;

	if (nCmd == SET_AUDIO_CH)
	{
		switch (nValue1)
		{
		case _AUDIO_OLD_CH_OPTICAL:
			lSource1 = _AUDIO_NEW_CH_SPDIF_R;
			lSource2 = _AUDIO_NEW_CH_SPDIF_L;
			break; 

		case 	_AUDIO_OLD_CH_COAXIAL:
			lSource1 = _AUDIO_NEW_CH_SPDIF_R;
			lSource2 = _AUDIO_NEW_CH_SPDIF_L;
			break;

		case 	_AUDIO_OLD_CH_BCH1:
			lSource1 = _AUDIO_NEW_CH_SPEAK_1R;
			lSource2 = _AUDIO_NEW_CH_SPEAK_1L;
			break;

		case 	_AUDIO_OLD_CH_BCH2:
			lSource1 = _AUDIO_NEW_CH_SPEAK_2R;
			lSource2 = _AUDIO_NEW_CH_SPEAK_2L;
			break;

		case 	_AUDIO_OLD_CH_BCH3:
			lSource1 = _AUDIO_NEW_CH_SPEAK_3R;
			lSource2 = _AUDIO_NEW_CH_SPEAK_3L;
			break;

		case 	_AUDIO_OLD_CH_BCH4:
			lSource1 = _AUDIO_NEW_CH_SPEAK_4R;
			lSource2 = _AUDIO_NEW_CH_SPEAK_4L;


			break;
		case 	_AUDIO_OLD_CH_AUX:
			lSource1 = _AUDIO_NEW_CH_AUX_R;
			lSource2 = _AUDIO_NEW_CH_AUX_L;
			break;

		case 	_AUDIO_OLD_CH_SCART:
			lSource1 = _AUDIO_NEW_CH_MIC1;//MIC
			lSource2 = _AUDIO_NEW_CH_MIC2;//MIC
			break;

		case 	_AUDIO_OLD_CH_HDMI:
			lSource1 = _AUDIO_NEW_CH_HDMI_R;
			lSource2 = _AUDIO_NEW_CH_HDMI_L;
			break;
			
		default:
			break;
		}
		g_pView->SetChannelDataSeq(1, lSource1);
		g_pView->SetChannelDataSeq(2, lSource2);
		//nValue1
		//SetChannelDataSeq(int lTestChannel, int lSource);

		g_CurSetting.m_nAudioSource = nValue1;
	}
	else
	{
		szCmdString = MakeCmdString(nCmd, szSwitchBoxMsg, nValue1, nValue2);
...
BOOL CAvSwitchBox::SendRemoteCmd(int nWaitLimit, int nRemoteType, CString sCustom, CString sCmd, int nByte)
{
	...
	//	m_pMainDlg->ComLog_AddString(sTmp); //AddStringToRemoteComLog(sTmp);
	//}
