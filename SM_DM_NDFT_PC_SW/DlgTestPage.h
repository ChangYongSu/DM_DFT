...
//	CComboBox m_cComboRmtSelect;
	...
	CComboBox m_cComboVoltNo[3];

	afx_msg void OnBnClickedButtonVibSweep();
	afx_msg void OnHScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar);
	CSliderCtrl m_cSliderFrequency;
	CString m_EditSlideData;
	afx_msg void OnBnClickedButtonSlideSet();
	afx_msg void OnBnClickedButtonUpdinRead();
	
	afx_msg void OnBnClickedCheckUsb1();
	CButton m_CheckUSB1;
	CButton m_CheckUSB2;
	afx_msg void OnBnClickedCheckUsb2();
	afx_msg void OnBnClickedButtonSaveFreq();
	afx_msg void OnBnClickedButtonFreq13();
	afx_msg void OnBnClickedCheckMic1();
	afx_msg void OnBnClickedCheckMic2();
	CButton m_cCheckMic1;
	CButton m_cCheckMic2;
};
