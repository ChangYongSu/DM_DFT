...
void CDlgPassword::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_EDIT_ENTER_PASSWORD, m_cEditCtrlPassword);
}
...
BOOL CDlgPassword::OnInitDialog()
{
	...
	//GetDlgItem(IDC_EDIT_ENTER_PASSWORD)->SetFocus();
	m_cEditCtrlPassword.SetFocus();
...
void CDlgPassword::OnTimer(UINT_PTR nIDEvent)
{
