...
#define DEBUG_NEW_HDFT

#define _SM_DEBUG

#define VIDEO_DFT_SEQ 1


#define  MAX_COLUMN_NO	14
#define AUDIO_CHANNEL_NO	8
...
#define  COM_ID_HDMI_SC_PORT	12
#define  COM_ID_AUDIO_PORT		13


#define PATH_BASE_DIR "D:\\DM_HDFT"

#define PASSWORD_PATH_BASE_DIR "C:\\SM Digital"

#define LINE_CM45 0
#define LINE_CM89 1

#define USB_SEL_UART_MODE_	1
#define USB_SEL_PLAY_MODE_	0
...
//#define TEST_SEQ_TYPE_AC_POWER_ON			31 //ac_power_on(50000)
//#define TEST_SEQ_TYPE_AC_POWER_OFF			32 //ac_power_off(50000)
#define TEST_SEQ_TYPE_POWER_ON_CHECK		33 //power_check(50000)
//#define TEST_SEQ_TYPE_OPEN_CHECK		34 //open_check(50000)
//#define TEST_SEQ_TYPE_CLOSE_CHECK		35 //close_check(50000)
#define TEST_SEQ_TYPE_SET_VIDEO				36
//#define TEST_SEQ_TYPE_SET_DIGITAL_SPDIF		37
#define TEST_SEQ_TYPE_WAIT_MASSAGE			38
//
//
//#define TEST_SEQ_TYPE_COLOR_CHECK			38 //color_check(ref_dvd_pass,50,1,50, 50000)
//#define TEST_SEQ_TYPE_COLOR_RED_CHECK			39 //display_red_check(ref_bp350, 5000)
//#define TEST_SEQ_TYPE_COLOR_GREEN_CHECK			40 //display_green_check(ref_bp350, 5000)
//#define TEST_SEQ_TYPE_COLOR_BLUE_CHECK			41 //display_blue_check(ref_bp350, 5000)
...
#define		SETTING_MODE_RANGE1		1
#define		SETTING_MODE_RANGE2		2//m_SettingMode
...
#define _CLOSE_DISPLAY_NGCLICK		4
...
#define IR_REMOTE_CA 0
#define IR_REMOTE_RF 1
...
//extern UINT g_nPort_HDMI;
//extern UINT g_nBaud_HDMI;
//extern UINT g_nParity_HDMI;
...
extern UINT g_CheckUseUSB_Scanner;
extern UINT g_nNI_CardSel;
extern UINT g_nVIDEO_CardSel;
...
extern CString g_strMesModelName;
extern CString g_strModelSuffix;

extern CString g_strProcessFileName;
