...
CString CIniAccess::GetProfileString(CString szSection, CString szField, CString sDefault)
{
	CString szValue;
...
VOID CIniAccess::WriteProfileInt(CString szSection, CString szField, int nData)
{
	CString val;
	val.Format("%d",nData);
	int status = WritePrivateProfileString( szSection.GetBuffer(szSection.GetLength()),
...
VOID CIniAccess::WriteProfileString(CString szSection, CString szField, CString szData)
{
	WritePrivateProfileString( szSection.GetBuffer(szSection.GetLength()),
							   szField.GetBuffer(szField.GetLength()),
						       szData.GetBuffer(szData.GetLength()),
