...
public:
	...
	VOID WriteProfileString(CString szSection, CString szField, CString szData);
	VOID SetProfileInt(CString szSection, CString szField, int nData);
	VOID WriteProfileInt(CString szSection, CString szField, int nData);

	CString GetProfileString(CString section, CString field, CString sDefault = "");
