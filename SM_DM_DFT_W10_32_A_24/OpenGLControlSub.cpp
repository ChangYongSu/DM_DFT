...
COpenGLControlSub::COpenGLControlSub(void)
{
	...
	m_DisplayPage = __DISPLAY_PAGE_TOTAL_LEFT;
}
...
BEGIN_MESSAGE_MAP(COpenGLControlSub, CWnd)
	ON_WM_PAINT()
	ON_WM_SIZE()
	ON_WM_CREATE()
	ON_WM_TIMER()
...
void COpenGLControlSub::OnPaint()
{
	//CPaintDC dc(this); // device context for painting
	ValidateRect(NULL);
}

void COpenGLControlSub::destroy(void)
{
	if (hrc != NULL)
	{
...
void COpenGLControlSub::OnSize(UINT nType, int cx, int cy)
{
...
int COpenGLControlSub::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
void COpenGLControlSub::OnDraw(CDC *pDC)
{
...
void COpenGLControlSub::OnTimer(UINT_PTR  nIDEvent)
{
	switch (nIDEvent)
	{
		case 1:
...
void COpenGLControlSub::OnMouseMove(UINT nFlags, CPoint point)
{
	/*
...
void COpenGLControlSub::oglCreate(CRect rect, CWnd *parent, LPCTSTR lWindName)
{
...
void COpenGLControlSub::oglInitialize(void)
{
	// Initial Setup:
	//
...
//
//GLvoid COpenGLControlSub::BuildFont(GLvoid)  
//{  
//    HFONT font; // <1>  
...
//}  
//
//GLvoid COpenGLControlSub::KillFont(GLvoid)  
//{  
//    glDeleteLists(base, 96);  
//}  
//
//GLvoid COpenGLControlSub::glPrint(const char *text)  
//{  
...
//
//void COpenGLControlSub::oglDrawScene(void)
//{
//	// Wireframe Mode
...
void COpenGLControlSub::DrawGLScene()
{
...
void  COpenGLControlSub::DrawISFD() 
{
...
void  COpenGLControlSub::SMglNumber(int lnumber,float lPosX , float lPosY , float lFontSize, int lwidth)
{
...
void  COpenGLControlSub::SMglChar(char lAlpha,float lPosX , float lPosY , float lFontSize, int lwidth)
{
...
void  COpenGLControlSub::SMglArc(float lCentX, float lCenty, float lRadius, float lStart, float lAngleSize,  int lStep )
{
...
void  COpenGLControlSub::SMglCircle(float lCentX, float lCenty, float lRadius, float lStart, float lAngleSize,  int lStep )
{
...
void  COpenGLControlSub::DrawRollTick()
{
	int iNum = 0;
	float fFont;
	int iWidth;
...
void  COpenGLControlSub::DrawPlot()
{
	int iNum = 0;
	float fFont;
	int iWidth;
	...
	{	
		...
		glVertex3f(i*0.002 + 0.01, m_PlotDataR[i].Data, 0.0f);
		glVertex3f((i + 1)*0.002 + 0.01, m_PlotDataR[i + 1].Data, 0.0f);
...
//void  COpenGLControlSub::DrawSkyGround()
//{
//	glPushMatrix();
//
//		glRotatef(m_fRotZ, 0.0f, 0.0f, 1.0f);
...
//void  COpenGLControlSub::DrawHeading()
//{
//
//
//	
...
//void  COpenGLControlSub::DrawOutLine()
//{
//
//	//glBegin(GL_TRIANGLES);
//	//	glColor3f(0.5f,0.5f,0.5f);
...
//}
//
//void COpenGLControlSub::DrawWingShip()
//{
//	//Wing Ship Center
//	glBegin(GL_QUADS);
//		glColor3f(0.0f,0.0f,0.0f);
...
//}
//
//void COpenGLControlSub::DrawPitchLadder()
//{
//	int i;
