...
//
//----------------------------------------------------------------------------------
#ifdef KEYDLL1_EXPORTS
#define KEYDLL1_API __declspec(dllexport)
#else
#define KEYDLL1_API __declspec(dllimport)
#endif

KEYDLL1_API void installhook1(HWND h);//This function installs the Keyboard hook.
KEYDLL1_API void removehook1();//This function removes the previously installed hook.
KEYDLL1_API LRESULT CALLBACK hookproc1(int ncode,WPARAM wparam,LPARAM lparam);//This function is called when the keyboard is operated.